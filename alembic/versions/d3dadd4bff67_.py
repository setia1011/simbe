...
Revision ID: d3dadd4bff67
Revises: 
Create Date: 2024-01-23 21:11:20.160493
...
def upgrade() -> None:
    ...
    op.create_table('user_id_type',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_type', sa.String(length=50), nullable=False),
    sa.Column('id_description', sa.String(length=225), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_id_type_id'), 'user_id_type', ['id'], unique=False)
    op.create_index(op.f('ix_user_id_type_id_type'), 'user_id_type', ['id_type'], unique=True)
    ...
    sa.ForeignKeyConstraint(['id_type'], ['user_id_type.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_user_id_type_id_type'), table_name='user_id_type')
    op.drop_index(op.f('ix_user_id_type_id'), table_name='user_id_type')
    op.drop_table('user_id_type')
